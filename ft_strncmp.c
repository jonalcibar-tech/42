...
/*   Updated: 2026/05/12 12:07:30 by jalcibar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_strncmp(const char *s1, const char *s2, size_t n)
{
	...
	len_s2 = ft_strlen(s2);
	count = 0;
	count_lim = (len_s1 * ((len_s1 < n) && (len_s1 < len_s2))
	 + len_s2 * ((len_s2 < n) && (len_s2 < len_s1))
	 + n * ((n < len_s1) && (n < len_s2)));
	printf("%d\n", count_lim);
...
int main(void)
{
	const char str1[] = "LOLAS";
	const char str2[] = "LOLBT";
	size_t n;
